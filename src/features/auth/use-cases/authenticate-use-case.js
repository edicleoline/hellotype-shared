...
let AuthenticateUseCase = class AuthenticateUseCase extends use_case_1.default {
    ...
    execute(request) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.remoteAuthDataSource.authenticate(request.token, request.password, request.user);
        });
    }
};
...
exports.default = AuthenticateUseCase;
